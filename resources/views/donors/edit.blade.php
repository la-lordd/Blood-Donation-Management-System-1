        ...
        <form action="{{ route('donors.update', $donor) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <input type="date" name="date_of_birth"
                           value="{{ old('date_of_birth', $donor->date_of_birth) }}"
            ...
            <div class="mt-5">
                ...
                <textarea name="address" rows="3"
                          class="w-full border border-gray-300 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-red-400 @error('address') border-red-500 @enderror">{{ old('address', $donor->address) }}</textarea>
                @error('address')
                    <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                @enderror
            </div>
